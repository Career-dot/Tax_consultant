...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .success-alert {
            background: linear-gradient(135deg, #e8fdf0, #d4fddb);
            border: 1px solid #c6f5cf;
    ...
    <div class="auth-form-panel">
        <div class="form-container">
            <div class="form-header">
                ...
                <p>Enter your email address and we'll send you a link to reset your password. Need to sign in? <a href="{{ route('login') }}">Back to login</a></p>
            </div>

            @if(session('status'))
                <div class="success-alert">
                    <p><i class="fas fa-check-circle me-1"></i> {{ session('status') }}</p>
                </div>
            @endif
